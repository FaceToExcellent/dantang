//
//  chineseCalendarViewController.m
//  dantang
//
...
#import "FSCalendar.h"
//MARK: 这里需要在info.plist 里面加上下面这个键值对 不然无法运行
//Privacy - Calendars Usage Description ： Events
//这个虹之间的对象默认制空 nill
NS_ASSUME_NONNULL_BEGIN

@interface chineseCalendarViewController()<FSCalendarDataSource,FSCalendarDelegate,FSCalendarDelegateAppearance>
...
@implementation chineseCalendarViewController
